...
class ArtifactControllerTest {
    ...
    void testAddArtifactSuccess() throws Exception {
        ...
        // When and then
        this.mockMvc.perform(post(this.baseUrl + "/api/v1/artifacts").contentType(MediaType.APPLICATION_JSON).content(json).accept(MediaType.APPLICATION_JSON))
                .andExpect(jsonPath("$.flag").value(true))
                .andExpect(jsonPath("$.code").value(StatusCode.SUCCESS))
    ...
    void testUpdateArtifactSuccess() throws Exception {
        ...
        // When and then
        this.mockMvc.perform(put(this.baseUrl + "/api/v1/artifacts/1250808601744904192").contentType(MediaType.APPLICATION_JSON).content(json).accept(MediaType.APPLICATION_JSON))
                .andExpect(jsonPath("$.flag").value(true))
                .andExpect(jsonPath("$.code").value(StatusCode.SUCCESS))
    ...
    void testUpdateArtifactErrorWithNonExistentId() throws Exception {
        ...
        given(this.artifactService.update(eq("1250808601744904192"), Mockito.any(Artifact.class))).willThrow(new ObjectNotFoundException(Optional.of("artifact"), "1250808601744904192"));
    ...
    void testDeleteArtifactErrorWithNonExistentId() throws Exception {
        // Given
        doThrow(new ObjectNotFoundException(Optional.of("artifact"), "1250808601744904191")).when(this.artifactService).delete("1250808601744904191");
